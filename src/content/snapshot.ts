...
export const snapshot: SiteContent = {
  ...
  feedbackPage: {
    eyebrow: 'תודה שהתארחתם',
    title: 'איך הייתה השבת אצלנו?',
    intro:
      'שתי דקות מהזמן שלכם עוזרות לנו יותר מכל דבר אחר — גם לדעת מה עבד, וגם לדעת מה לתקן לפעם הבאה.',
    nameLabel: 'השם שלכם',
    contextLabel: 'מתי התארחתם ובאיזו הזדמנות',
    contextHint: 'למשל: שבת חתן, פרשת בהעלותך',
    ratingLabel: 'איך הייתה החוויה בסך הכול?',
    quoteLabel: 'מה הכי אהבתם?',
    quoteHint: 'זה החלק שנשמח לפרסם באתר, באישורכם.',
    privateLabel: 'משהו שנוכל לשפר?',
    privateHint: 'זה מגיע אלינו בלבד ולא יפורסם בשום מקום. תכתבו בפתיחות — זה מה שעוזר.',
    phoneLabel: 'טלפון',
    phoneHint: 'רק אם תרצו שנחזור אליכם. לא יפורסם.',
    consentLabel: 'אפשר לפרסם את מה שכתבתי באתר, לצד השם שלי',
    submit: 'שליחת הפידבק',
    thanksTitle: 'תודה רבה!',
    thanksBody: 'קיבלנו את הפידבק שלכם וקראנו כל מילה. זה באמת עוזר לנו.',
    backCta: 'למתחם האירוח',
  },
